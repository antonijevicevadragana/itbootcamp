...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($ime)) {
        ...
        $errMsg['ime'] = 'U polju ime nije dozvoljen unos cifara'; //kad se pravi niz errora moze $errMsg['ime'][] i bice if, if,
    }
    ...
    if (count($errMsg) == 0) {
        $q="UPDATE `studenti` SET `ime`='".$ime."', `prezime` = '".$prezime."',
        ...
        $r = $conn->query($q);
        if ($r) {
            //uspesno izmenje student prebaci ga na index.php
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="id" value="<?php echo $id?>"> 
                            <div class="form-group mb-3">
                                <label>Ime:</label>
                                <input type="text" name="ime" class="form-control <?php if (isset($errMsg['ime'])) echo "is-invalid"; ?>" value="<?php echo $ime; ?>"> <!-- vrednost atributa NAME mora da bude jedinstveno na nivo forme jer je to klju u asocijativnom nizu kada se preuzmu parametri -->
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="broj_telefona" class="form-control <?php if (isset($errMsg['broj_telefona'])) {
                                                                                                echo "is-invalid";
